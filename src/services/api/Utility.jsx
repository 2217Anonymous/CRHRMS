...
import { ACTIVE_MODULE_LIST_URL, ACTIVE_SUBMODULE_LIST_URL, ADD_MODULE_URL, ADD_OPERATION_URL, ADD_SUBMODULE_URL, CITY_LIST_URL, COUNTRY_LIST_URL, HISTORY_URL, INSERT_MODULE_OPERATION_URL, MODULE_LIST_URL, MODULE_STATUS_URL, OPERATION_LIST_URL, OPERATION_STATUS_URL, STATE_LIST_URL, SUBMODULE_LIST_URL, SUBMODULE_STATUS_URL } from "./ApiUrl"
const browser = {
    ipAddress:'127.0.0.1',
...
export const getHistoryList = (id,name) => {
    return axios.post(HISTORY_URL,{tablename:name,rowid:id})
}   
