        ...
        <PerfectScrollbar options={{ suppressScrollX: true, useBothWheelAxes: false }}>
          <div className="side-header">
            <Link className="header-brand1" to={`/Dashboard/`}>
              <img src={require("../../assets/logo/Cr-whte.png")} style={{width:'150px'}} className="header-brand-img desktop-logo" alt="logo1" />
              <img src={require("../../assets/logo/Hen-White.png")} className="header-brand-img toggle-logo" alt="logo-2" />
              <img src={require("../../assets/logo/Hen-Dark.png")} className="header-brand-img light-logo" alt="logo-3" />
              <img src={require("../../assets/logo/Cr-Full-Dark.png")} style={{width:'150px'}} className="header-brand-img light-logo1" alt="logo-4" />
            </Link>
          </div>
          <div className="main-sidemenu">
            ...
            <ul className="side-menu" style={{ marginLeft: "0px" }}>
              {
                MENUITEMS.map((menu) => {
                  <li className="sub-category"><h3>{menu}</h3></li>
                })
              }
            </ul>
